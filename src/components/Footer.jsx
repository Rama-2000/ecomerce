        ...
        <div className='footer'>
            <div className="wrapper">
                <div className="row">
                    ...
                    <div className="column">
                        <div className="title"><h4>Help & Contact</h4></div>
                            <Link className='footer__link'>Resolution Center</Link>
                            <Link className='footer__link'>Seller Information Center</Link>
